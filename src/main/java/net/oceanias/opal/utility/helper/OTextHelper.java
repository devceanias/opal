...
public final class OTextHelper {
    ...
    public final String CHAT_DIVIDER_SHORT =
    ...
    public final String CHAT_DIVIDER_LONG =
    ...
    public final String LORE_DIVIDER_SHORT =
    ...
    public final String LORE_DIVIDER_LONG =
